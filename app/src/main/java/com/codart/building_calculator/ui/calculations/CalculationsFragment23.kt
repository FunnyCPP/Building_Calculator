...
class CalculationsFragment23 : Fragment() {

    val ARRAY= arrayOf("Bergauf ERSTE GRUND"," Bergauf Praktik M-200"," Ceresit CN80"," Consolit 400",
            " Consolit 401"," Glims PRO FS Screed 1K"," Ivsil Termolite"," Plitonit P200"," Perfekta Фиброслой",
            " Knauf Boden 15"," Knauf UBO"," Mapei Topcem Pronto"," Murezin ZE 30 Zementestrich"," Sika Sikafloor 20 PurCem",
            " Sika Sikafloor Screed-100"," UNIS Горизонт Легкий"," Weisbau WB150 Пескобетон M150"," Бирсс №18 С"," Бирсс №16",
            " Бирсс №23"," Бирсс №53 С"," Бирсс №62"," Бирсс Рапид"," Старатели Стяжка С-10"," Старатели Стяжка Легкая",
            " Боларс Быстротвердеющая Основа БТ"," Боларс Высокопрочная Основа"," Основит Стартолайн FC41 H Высокопрочная",
            " Основит СТАРТОЛАЙН FC43 L Легкая"," Основит СТАРТОЛАЙН FC44 M"," Эталон М-300 Пескобетон")
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calculations23, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        spinner1 =requireView().findViewById(R.id.spinner1_calculations23)
        spinner2 =requireView().findViewById(R.id.spinner2_calculations23)
        //spinner3 =requireView().findViewById(R.id.spinner3_calculations23)
        spinner4 =requireView().findViewById(R.id.spinner4_calculations23)
        spinner5 =requireView().findViewById(R.id.spinner5_calculations23)
        spinner6 =requireView().findViewById(R.id.spinner6_calculations23)
        spinner8 =requireView().findViewById(R.id.spinner8_calculations23)

        input1 =requireView().findViewById(R.id.calculations23_input1)
        input2 =requireView().findViewById(R.id.calculations23_input2)
        input3 =requireView().findViewById(R.id.calculations23_input3)
        input4 =requireView().findViewById(R.id.calculations23_input4)
        input5 =requireView().findViewById(R.id.calculations23_input5)
        input6 =requireView().findViewById(R.id.calculations23_input6)
        input7 =requireView().findViewById(R.id.calculations23_input7)

        result1 =requireView().findViewById(R.id.calculations23_result1)
        result2 =requireView().findViewById(R.id.calculations23_result2)
        result3 =requireView().findViewById(R.id.calculations23_result3)
        result4 =requireView().findViewById(R.id.calculations23_result4)
        result5 =requireView().findViewById(R.id.calculations23_result5)
        result6 =requireView().findViewById(R.id.calculations23_result6)

        imgBottomSave=requireView().findViewById(R.id.imgBottomSave_calculations23)
        imgBottomHome=requireView().findViewById(R.id.imgBottomHome_calculations23)
        imgBottomCopy=requireView().findViewById(R.id.imgBottomCopy_calculations23)

        checkBox1=requireView().findViewById(R.id.calculations23_checkBox1)
        checkBox2=requireView().findViewById(R.id.calculations23_checkBox2)
        checkBox3=requireView().findViewById(R.id.calculations23_checkBox3)
        checkBox4=requireView().findViewById(R.id.calculations23_checkBox4)

        txt=requireView().findViewById(R.id.txt_calculations23)
        txt1=requireView().findViewById(R.id.txt1_calculations23)
        txt2=requireView().findViewById(R.id.txt2_calculations23)
        txt3=requireView().findViewById(R.id.txt3_calculations23)
        txt4=requireView().findViewById(R.id.txt4_calculations23)
        txt5=requireView().findViewById(R.id.txt5_calculations23)
    ...
    private fun getInfoAboutCalculations(): String{
        ...
        if(checkBox1.isChecked)
        {
            val input=requireContext().resources.getString(R.string.calculation23_text1)+" "+ARRAY[spinner1.selectedItemPosition]
            val input2=requireContext().resources.getString(R.string.calculation23_text2)+" "+input2.text.toString()+" шт"
            text1= """
            $input           
            $input2
        ...
        """.trimIndent()
            ...
            val input1Value=requireContext().resources.getString(R.string.calculation23_text3)+" "+input1.text.toString()+" кг/м2*мм"
            val input2Value=requireContext().resources.getString(R.string.calculation23_text2)+" "+input2.text.toString()+" "
            text1= """
            $input1Value
            $input2Value
        ...
        if(checkBox3.isChecked)
        {
            val input1Value=requireContext().resources.getString(R.string.calculation23_text4)+" "+input3.text.toString()+" "+spinner4.selectedItem.toString()
            val input2Value=requireContext().resources.getString(R.string.calculation23_text5)+" "+input4.text.toString()+" "+spinner5.selectedItem.toString()
            val input3Value=requireContext().resources.getString(R.string.calculation23_text7)+" "+input6.text.toString()+" кг"
            val input4Value=requireContext().resources.getString(R.string.calculation23_text8)+" "+input7.text.toString()+" руб"
            text2="""
                 $input1Value
                 $input2Value
                 $input3Value
        ...
        {
            val input1Value=requireContext().resources.getString(R.string.calculation23_text6)+" "+input5.text.toString()+" м2"
            val input3Value=requireContext().resources.getString(R.string.calculation23_text6)+" "+input6.text.toString()+" кг"
            val input4Value=requireContext().resources.getString(R.string.calculation23_text7)+" "+input7.text.toString()+" руб"
        ...
        val res="""
            ${requireContext().resources.getString(R.string.calculation23_text8)+" "+result1.text.toString()}
            ${requireContext().resources.getString(R.string.calculation23_text9)+" "+result2.text.toString()}
            ${requireContext().resources.getString(R.string.calculation23_text10)+" "+result3.text.toString()}
            ${requireContext().resources.getString(R.string.calculation23_text11)+" "+result4.text.toString()}
            ${requireContext().resources.getString(R.string.calculation23_text12)+" "+result5.text.toString()}
            ${requireContext().resources.getString(R.string.calculation23_text13)+" "+result6.text.toString()}
