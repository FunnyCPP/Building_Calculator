...
class CalculationsFragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calculations1, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        spinner1 =requireView().findViewById(R.id.spinner1_caculations1)
        spinner2 =requireView().findViewById(R.id.spinner2_caculations1)
        spinner3 =requireView().findViewById(R.id.spinner3_caculations1)
        spinner4 =requireView().findViewById(R.id.spinner4_caculations1)

        sizeA =requireView().findViewById(R.id.calculations1_sizeA)
        sizeB =requireView().findViewById(R.id.calculations1_sizeB)
        sizeC =requireView().findViewById(R.id.calculations1_sizeC)
        price =requireView().findViewById(R.id.calculations1_price)

        result1 =requireView().findViewById(R.id.calculations1_result1)
        result2 =requireView().findViewById(R.id.calculations1_result2)
        result3 =requireView().findViewById(R.id.calculations1_result3)
        result4 =requireView().findViewById(R.id.calculations1_result4)
        result5 =requireView().findViewById(R.id.calculations1_result5)
        result6 =requireView().findViewById(R.id.calculations1_result6)
        result7 =requireView().findViewById(R.id.calculations1_result7)

        imgBottomSave=requireView().findViewById(R.id.imgBottomSave_calculations1)
        imgBottomHome=requireView().findViewById(R.id.imgBottomHome_calculations1)
        imgBottomCopy=requireView().findViewById(R.id.imgBottomCopy_calculations1)
    ...
    private fun calculate1to6results(){
        ...
        val res3=(a+b)*2
        val res4=(a*c+b*c)*2
        val res5=a*b*c*Values.densityBeton
    ...
    private fun calculate7result(){
        ...
        result7.text= "$res ${spinner4.selectedItem}"
    }
