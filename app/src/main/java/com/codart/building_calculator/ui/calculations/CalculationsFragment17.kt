...
class CalculationsFragment17 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calculations17, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        spinner1 =requireView().findViewById(R.id.spinner1_calculations17)
        spinner2 =requireView().findViewById(R.id.spinner2_calculations17)
        spinner3 =requireView().findViewById(R.id.spinner3_calculations17)
        spinner4 =requireView().findViewById(R.id.spinner4_calculations17)
        spinner5 =requireView().findViewById(R.id.spinner5_calculations17)



        input1 =requireView().findViewById(R.id.calculations17_input1)
        input2 =requireView().findViewById(R.id.calculations17_input2)
        input3 =requireView().findViewById(R.id.calculations17_input3)
        input4 =requireView().findViewById(R.id.calculations17_input4)


        result1 =requireView().findViewById(R.id.calculations17_result1)
        result2 =requireView().findViewById(R.id.calculations17_result2)


        imgBottomSave=requireView().findViewById(R.id.imgBottomSave_calculations17)
        imgBottomHome=requireView().findViewById(R.id.imgBottomHome_calculations17)
        imgBottomCopy=requireView().findViewById(R.id.imgBottomCopy_calculations17)
    ...
    private fun calculate1to4results(){
        val a=getFieldInM(input1, spinner2)
        val b=getFieldInM(input2, spinner3)
        val c=getFieldInM(input3, spinner4)
        val d=getFieldInM(input4, spinner5)
    ...
    private fun setSpinnersAdapters(){
        ...
        array=resources.getStringArray(R.array.calculations17_array1)
    ...
    private fun getInfoAboutCalculations(): String{
        val input1Value=requireContext().resources.getString(R.string.calculation17_text1)+" "+input1.text.toString()+" "+getSpinnerItem(spinner1)
        val input2Value=requireContext().resources.getString(R.string.calculation17_text2)+" "+input2.text.toString()+" "+getSpinnerItem(spinner2)
        val input3Value=requireContext().resources.getString(R.string.calculation17_text3)+" "+input3.text.toString()+" "+getSpinnerItem(spinner3)
        val input4Value=requireContext().resources.getString(R.string.calculation17_text4)+" "+input4.text.toString()+" "+getSpinnerItem(spinner4)

        val res1Value=requireContext().resources.getString(R.string.calculation17_text5)+" "+result1.text.toString()
        val res2Value=requireContext().resources.getString(R.string.calculation17_text6)+" "+result2.text.toString()
