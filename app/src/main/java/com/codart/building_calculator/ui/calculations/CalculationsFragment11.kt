...
class CalculationsFragment11 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calculations11, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        spinner1 =requireView().findViewById(R.id.spinner1_calculations11)
        spinner2 =requireView().findViewById(R.id.spinner2_calculations11)
        spinner3 =requireView().findViewById(R.id.spinner3_calculations11)
        spinner4 =requireView().findViewById(R.id.spinner4_calculations11)


        input1 =requireView().findViewById(R.id.calculations11_input1)
        input2 =requireView().findViewById(R.id.calculations11_input2)
        input3 =requireView().findViewById(R.id.calculations11_input3)

        result1 =requireView().findViewById(R.id.calculations11_result1)

        imgBottomSave=requireView().findViewById(R.id.imgBottomSave_calculations11)
        imgBottomHome=requireView().findViewById(R.id.imgBottomHome_calculations11)
        imgBottomCopy=requireView().findViewById(R.id.imgBottomCopy_calculations11)

        checkBox1=requireView().findViewById(R.id.calculations11_checkBox1)
        checkBox2=requireView().findViewById(R.id.calculations11_checkBox2)

        txt1=requireView().findViewById(R.id.txt1_calculations11)
        txt2=requireView().findViewById(R.id.txt2_calculations11)
        txt3=requireView().findViewById(R.id.txt3_calculations11)
        txt4=requireView().findViewById(R.id.txt4_calculations11)
    ...
    private fun getInfoAboutCalculations(): String{
        ...
        """.trimIndent()
            ...
            val res=requireContext().resources.getString(R.string.calculation12_text5)+" "+result1.text.toString()+" шт"
            return """
            $input1Value
            $input2Value
            $input3Value
    ...
    private fun getInfoResultAboutCalculations(): String{
        val res1Value=requireContext().resources.getString(R.string.calculation12_text5)+" "+result1.text.toString()
