...
class CalculationsFragment28 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calculations28, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        spinner1 =requireView().findViewById(R.id.spinner1_calculations28)
        spinner2 =requireView().findViewById(R.id.spinner2_calculations28)
        spinner3 =requireView().findViewById(R.id.spinner3_calculations28)
        spinner5 =requireView().findViewById(R.id.spinner5_calculations28)


        input1 =requireView().findViewById(R.id.calculations28_input1)
        input2 =requireView().findViewById(R.id.calculations28_input2)
        input3 =requireView().findViewById(R.id.calculations28_input3)
        input4 =requireView().findViewById(R.id.calculations28_input4)
        input5 =requireView().findViewById(R.id.calculations28_input5)


        result1 =requireView().findViewById(R.id.calculations28_result1)
        result2 =requireView().findViewById(R.id.calculations28_result2)
        result3 =requireView().findViewById(R.id.calculations28_result3)
        result4 =requireView().findViewById(R.id.calculations28_result4)
        result5 =requireView().findViewById(R.id.calculations28_result5)


        imgBottomSave=requireView().findViewById(R.id.imgBottomSave_calculations28)
        imgBottomHome=requireView().findViewById(R.id.imgBottomHome_calculations28)
        imgBottomCopy=requireView().findViewById(R.id.imgBottomCopy_calculations28)
    ...
    private fun getInfoAboutCalculations(): String{
        val input1Value=requireContext().resources.getString(R.string.calculation28_text1)+" "+input1.text.toString()+" "+getSpinnerItem(spinner1)
        val input2Value=requireContext().resources.getString(R.string.calculation28_text2)+" "+input2.text.toString()+" "+getSpinnerItem(spinner2)
        val input3Value=requireContext().resources.getString(R.string.calculation28_text3)+" "+input3.text.toString()+" "+getSpinnerItem(spinner3)
        val input4Value=requireContext().resources.getString(R.string.calculation28_text4)+" "+input4.text.toString()+" ед"
        val input5Value=requireContext().resources.getString(R.string.calculation28_text5)+" "+input5.text.toString()+" руб"
        val res1=requireContext().resources.getString(R.string.calculation28_text6)+" "+result1.text.toString()
        val res2=requireContext().resources.getString(R.string.calculation28_text7)+" "+result2.text.toString()
        val res3=requireContext().resources.getString(R.string.calculation28_text8)+" "+result3.text.toString()
        val res4=requireContext().resources.getString(R.string.calculation28_text9)+" "+result4.text.toString()
        val res5=requireContext().resources.getString(R.string.calculation28_text10)+" "+result5.text.toString()
