...
class CalculationsFragment3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calculations3, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        spinner1 =requireView().findViewById(R.id.spinner1_calculations3)
        spinner2 =requireView().findViewById(R.id.spinner2_calculations3)
        spinner3 =requireView().findViewById(R.id.spinner3_calculations3)
        spinner4 =requireView().findViewById(R.id.spinner4_calculations3)
        spinner5 =requireView().findViewById(R.id.spinner5_calculations3)

        sizeA =requireView().findViewById(R.id.calculations3_sizeA)
        sizeB =requireView().findViewById(R.id.calculations3_sizeB)
        sizeC =requireView().findViewById(R.id.calculations3_sizeC)
        sizeD =requireView().findViewById(R.id.calculations3_sizeD)
        price =requireView().findViewById(R.id.calculations3_price)

        result1 =requireView().findViewById(R.id.calculations3_result1)
        result2 =requireView().findViewById(R.id.calculations3_result2)
        result3 =requireView().findViewById(R.id.calculations3_result3)
        result4 =requireView().findViewById(R.id.calculations3_result4)
        result5 =requireView().findViewById(R.id.calculations3_result5)
        result6 =requireView().findViewById(R.id.calculations3_result6)
        result7 =requireView().findViewById(R.id.calculations3_result7)

        imgBottomSave=requireView().findViewById(R.id.imgBottomSave_calculations3)
        imgBottomHome=requireView().findViewById(R.id.imgBottomHome_calculations3)
        imgBottomCopy=requireView().findViewById(R.id.imgBottomCopy_calculations3)
    ...
    private fun calculate1to6results(){
        ...
        val res1=a*b-((a-2*d)*(b-2*d))+(a-2*d)*d
        val res2=res1*c
        val res3=(a+b)*2
        val res4=(a*c+b*c)*2
