...
class CalculationsFragment44 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calculations44, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        spinner1 =requireView().findViewById(R.id.spinner1_calculations44)
        spinner2 =requireView().findViewById(R.id.spinner2_calculations44)
        spinner3 =requireView().findViewById(R.id.spinner3_calculations44)
        spinner5 =requireView().findViewById(R.id.spinner5_calculations44)
        spinner6 =requireView().findViewById(R.id.spinner6_calculations44)


        input1 =requireView().findViewById(R.id.calculations44_input1)
        input2 =requireView().findViewById(R.id.calculations44_input2)
        input3 =requireView().findViewById(R.id.calculations44_input3)
        input4 =requireView().findViewById(R.id.calculations44_input4)
        input5 =requireView().findViewById(R.id.calculations44_input5)
        input6 =requireView().findViewById(R.id.calculations44_input6)


        result1 =requireView().findViewById(R.id.calculations44_result1)
        result2 =requireView().findViewById(R.id.calculations44_result2)
        result3 =requireView().findViewById(R.id.calculations44_result3)
        result4 =requireView().findViewById(R.id.calculations44_result4)
        result5 =requireView().findViewById(R.id.calculations44_result5)


        imgBottomSave=requireView().findViewById(R.id.imgBottomSave_calculations44)
        imgBottomHome=requireView().findViewById(R.id.imgBottomHome_calculations44)
        imgBottomCopy=requireView().findViewById(R.id.imgBottomCopy_calculations44)
    ...
    private fun calculate1to6results(){
        ...
        val p1=input5.text.toString().toDouble()
        val p2=input6.text.toString().toDouble()
        val res1= a*b*c
        val res2=res1*n
        val res3= res1*p1
        val res4= res1*p2
        ...
        result3.text = "${Round.round(res3)} ${spinner5.selectedItem}"
