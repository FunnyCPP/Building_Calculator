...
class FragmentCalculation31 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        spinner1 =requireView().findViewById(R.id.spinner1_calculations31)
        spinner2 =requireView().findViewById(R.id.spinner2_calculations31)
        spinner3 =requireView().findViewById(R.id.spinner3_calculations31)
        spinner4 =requireView().findViewById(R.id.spinner4_calculations31)

        input1 =requireView().findViewById(R.id.calculations31_input1)
        input2 =requireView().findViewById(R.id.calculations31_input2)
        input3 =requireView().findViewById(R.id.calculations31_input3)
        input4 =requireView().findViewById(R.id.calculations31_input4)

        result1 =requireView().findViewById(R.id.calculations31_result1)
        result2 =requireView().findViewById(R.id.calculations31_result2)
        result3 =requireView().findViewById(R.id.calculations31_result3)
        result4 =requireView().findViewById(R.id.calculations31_result4)
        result5 =requireView().findViewById(R.id.calculations31_result5)
        result6 =requireView().findViewById(R.id.calculations31_result6)

        imgBottomSave=requireView().findViewById(R.id.imgBottomSave_calculations31)
        imgBottomHome=requireView().findViewById(R.id.imgBottomHome_calculations31)
        imgBottomCopy=requireView().findViewById(R.id.imgBottomCopy_calculations31)
    ...
    private fun calculate1to6results(){
        ...
        val b= getFieldinMetres(spinner2,input2)/2
