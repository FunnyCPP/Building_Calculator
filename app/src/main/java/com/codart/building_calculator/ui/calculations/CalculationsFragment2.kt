...
class CalculationsFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calculations2, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        spinner1 =requireView().findViewById(R.id.spinner1_caculations2)
        spinner2 =requireView().findViewById(R.id.spinner2_caculations2)
        spinner3 =requireView().findViewById(R.id.spinner3_caculations2)
        spinner4 =requireView().findViewById(R.id.spinner4_caculations2)
        spinner5 =requireView().findViewById(R.id.spinner5_caculations2)

        sizeA =requireView().findViewById(R.id.calculations2_sizeA)
        sizeB =requireView().findViewById(R.id.calculations2_sizeB)
        sizeC =requireView().findViewById(R.id.calculations2_sizeC)
        sizeD =requireView().findViewById(R.id.calculations2_sizeD)
        price =requireView().findViewById(R.id.calculations2_price)

        result1 =requireView().findViewById(R.id.calculations2_result1)
        result2 =requireView().findViewById(R.id.calculations2_result2)
        result3 =requireView().findViewById(R.id.calculations2_result3)
        result4 =requireView().findViewById(R.id.calculations2_result4)
        result5 =requireView().findViewById(R.id.calculations2_result5)
        result6 =requireView().findViewById(R.id.calculations2_result6)
        result7 =requireView().findViewById(R.id.calculations2_result7)

        imgBottomSave=requireView().findViewById(R.id.imgBottomSave_calculations2)
        imgBottomHome=requireView().findViewById(R.id.imgBottomHome_calculations2)
        imgBottomCopy=requireView().findViewById(R.id.imgBottomCopy_calculations2)
