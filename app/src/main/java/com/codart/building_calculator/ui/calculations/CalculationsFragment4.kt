...
class CalculationsFragment4 : Fragment() {
    ...
    private lateinit var sizeE: EditText
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calculations4, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        spinner1 =requireView().findViewById(R.id.spinner1_calculations4)
        spinner2 =requireView().findViewById(R.id.spinner2_calculations4)
        spinner3 =requireView().findViewById(R.id.spinner3_calculations4)
        spinner4 =requireView().findViewById(R.id.spinner4_calculations4)
        spinner5 =requireView().findViewById(R.id.spinner5_calculations4)
        spinner6 =requireView().findViewById(R.id.spinner6_calculations4)

        sizeA =requireView().findViewById(R.id.calculations4_sizeA)
        sizeB =requireView().findViewById(R.id.calculations4_sizeB)
        sizeC =requireView().findViewById(R.id.calculations4_sizeC)
        sizeD =requireView().findViewById(R.id.calculations4_sizeD)
        sizeE =requireView().findViewById(R.id.calculations4_sizeE)
        price =requireView().findViewById(R.id.calculations4_price)

        result1 =requireView().findViewById(R.id.calculations4_result1)
        result2 =requireView().findViewById(R.id.calculations4_result2)
        result3 =requireView().findViewById(R.id.calculations4_result3)
        result4 =requireView().findViewById(R.id.calculations4_result4)
        result5 =requireView().findViewById(R.id.calculations4_result5)
        result6 =requireView().findViewById(R.id.calculations4_result6)
        result7 =requireView().findViewById(R.id.calculations4_result7)

        imgBottomSave=requireView().findViewById(R.id.imgBottomSave_calculations4)
        imgBottomHome=requireView().findViewById(R.id.imgBottomHome_calculations4)
        imgBottomCopy=requireView().findViewById(R.id.imgBottomCopy_calculations4)
    ...
    fun checkMetricFields(){
        if(sizeA.text.isNotEmpty() && sizeB.text.isNotEmpty() && sizeC.text.isNotEmpty() && sizeD.text.isNotEmpty() && sizeE.text.isNotEmpty()) {
    ...
    private fun calculate1to6results(){
        ...
        val e= getSizeEinMetres()

        val res1=a*b-((a-2*d)*(b-2*d))+(a-2*d)*d+e*d-d*d
        val res2=res1*c
        val res3=(a+b)*2
        val res4=(a*c+b*c)*2
    ...
    private fun calculate7result(){
        ...
        result7.text=  "$res ${spinner6.selectedItem}"
    }
    ...
    private fun getSizeEinMetres(): Double{
        return when(spinner5.selectedItemPosition){
            0 -> sizeE.text.toString().toDouble()
            1 -> sizeE.text.toString().toDouble() / 100
            2 -> sizeE.text.toString().toDouble() / 1000
            else -> 0.toDouble()
        }
    }
    ...
    private fun getInfoAboutCalculations(): String{
        ...
        val sizeEValue=requireContext().resources.getString(R.string.sizeE)+" "+sizeE.text.toString()+" "+getSpinnerItem(spinner5)
