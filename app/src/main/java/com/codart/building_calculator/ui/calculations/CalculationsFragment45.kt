...
class CalculationsFragment45 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calculations45, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        spinner1 =requireView().findViewById(R.id.spinner1_calculations45)
        spinner2 =requireView().findViewById(R.id.spinner2_calculations45)
        spinner3 =requireView().findViewById(R.id.spinner3_calculations45)
        spinner4 =requireView().findViewById(R.id.spinner4_calculations45)
        spinner6 =requireView().findViewById(R.id.spinner6_calculations45)
        spinner7 =requireView().findViewById(R.id.spinner7_calculations45)


        input1 =requireView().findViewById(R.id.calculations45_input1)
        input2 =requireView().findViewById(R.id.calculations45_input2)
        input3 =requireView().findViewById(R.id.calculations45_input3)
        input4 =requireView().findViewById(R.id.calculations45_input4)
        input5 =requireView().findViewById(R.id.calculations45_input5)
        input6 =requireView().findViewById(R.id.calculations45_input6)
        input7 =requireView().findViewById(R.id.calculations45_input7)


        result1 =requireView().findViewById(R.id.calculations45_result1)
        result2 =requireView().findViewById(R.id.calculations45_result2)
        result3 =requireView().findViewById(R.id.calculations45_result3)
        result4 =requireView().findViewById(R.id.calculations45_result4)
        result5 =requireView().findViewById(R.id.calculations45_result5)


        imgBottomSave=requireView().findViewById(R.id.imgBottomSave_calculations45)
        imgBottomHome=requireView().findViewById(R.id.imgBottomHome_calculations45)
        imgBottomCopy=requireView().findViewById(R.id.imgBottomCopy_calculations45)
    ...
    private fun calculate1to6results(){
        ...
        val n=input5.text.toString().toInt()
        val p1=input6.text.toString().toDouble()
        val p2=input7.text.toString().toDouble()
        val res1= (c+d)/2*a*b
        val res2=res1*n
        val res3= res1*p1
        val res4= res1*p2
        ...
        result3.text = "${Round.round(res3)} ${spinner6.selectedItem}"
        result4.text = "${Round.round(res4)} ${spinner7.selectedItem}"
    ...
    private fun getInfoAboutCalculations(): String{
        val input1Value=requireContext().resources.getString(R.string.calculation44_text1)+" "+input1.text.toString()+" "+getSpinnerItem(spinner1)
        val input2Value=requireContext().resources.getString(R.string.calculation44_text2)+" "+input2.text.toString()+" "+getSpinnerItem(spinner2)
        val input3Value=requireContext().resources.getString(R.string.calculation44_text3)+" "+input3.text.toString()+" "+getSpinnerItem(spinner3)
        val input4Value=requireContext().resources.getString(R.string.calculation44_text4)+" "+input4.text.toString()+" кг/м3"
        val input5Value=requireContext().resources.getString(R.string.calculation44_text5)+" "+input5.text.toString()+" руб"
        val input6Value=requireContext().resources.getString(R.string.calculation44_text6)+" "+input6.text.toString()+" руб"
