...
class CategoriesGeneration {
    companion object{
        ...
        val calculations: Array<String> = arrayOf("Расчет фундаментной плиты","Расчет ленточного фундамента",
            "Расчет ленточного фундамента с двумя секциями ","Расчет ленточного фундамента с 3 секциями","Расчет ленточного фундамента с 4 секциями",
        ...
        private val titlesMainWalls: List<String> = arrayListOf("Расчет кирпичный стен","Расчет стен из блоков",
                "Расчет стен из блоков по своим размерам","Объем блоков/кирпича в м3","Объем блоков/кирпича в ярде3","Параметры стеновых блоков")

        //List of titles for Category 'Отделка и материалы'
        private val titlesMainMaterials: List<String> = arrayListOf("Количество утеплителя для стен и фундаментов","Расчет настила из досок/перекрытия",
